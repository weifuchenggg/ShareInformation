	...
	<div style="width: 100%;height:100%;background-color: lightblue">
		...
		<form id="form_edit" method="post" action="student_save">
			<table style="width: 504px;height: 90%;margin:auto" cellspacing=”10″
				...
				<input name="id" value=<s:property value="%{model.id}"/>>
				...
				<tr style="text-align: center">
					<td><label>班级:<input name="claname" value=<s:property value="%{model.claname.getCname()}"/>></td><!--  -->
					<td><label>专业:<input name="specialty" value=<s:property value="%{model.claname.getSpecialty().getSname()}"/>></td><!--  -->
				</tr>
				<tr style="text-align: center">
				...
				<tr>
					<td colspan="2"><label>学院:<input name="department" value=<s:property value="%{model.claname.getSpecialty().getDepartment().getDname()}"/>></td><!--  -->
				...
				<tr align="center">
					<td colspan="2">
						<!-- <input type="button" name="ok" value="编辑信息"
							class="bj"> -->
							<a id="save" href="student_edit.action" class="easyui-linkbutton" plain="true" icon="icon-save">保存</a>
					</td>
				</tr>
			</table>
		</form>
